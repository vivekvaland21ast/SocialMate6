                ...
                <div class="flex items-center justify-center">
                    ...
                    if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] == true) {
                        echo '
                                <a href="/profile">
                        <button
                            class="flex-1 rounded-full bg-blue-600 dark:bg-blue-800 text-white dark:text-white antialiased font-semibold text-md hover:bg-blue-800 dark:hover:bg-blue-900 px-6 py-3">
                            View Profile
                        </button>
                    </a>
                                ';
