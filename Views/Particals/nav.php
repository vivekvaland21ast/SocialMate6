<div class="navbar bg-base-100 w-full fixed top-0 h-10 z-50 mb-4 shadow-lg">
    ...
    <div class="navbar-center hidden lg:flex text-3xl font-semibold">
    ...
    <div class="navbar-end py-2">
        ...
        <dialog id="my_modal_3" class="modal">
            <div class="modal-box">
                ...
                <form class="p-4 md:p-5" method="POST" action="/post" enctype="multipart/form-data">
